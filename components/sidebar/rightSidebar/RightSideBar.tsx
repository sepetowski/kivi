	...
	return (
		<Sidebar left={true}>
			<div className='mt-24 w-full h-5/6 flex flex-col items-center lg:items-start p-4 lg:p-6 gap-6 lg:gap-10 text-sm '>
				...
				<div className='w-full h-full flex flex-col items-center lg:items-stretch  gap-4  xl:text-lg  scrollbar-thin scrollbar-thumb-secondary scrollbar-thumb-rounded-md scrollbar-track-background overflow-y-auto'>
