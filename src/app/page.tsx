...
export default async function Home() {
	...
	return (
		<>
			<header className='min-h-screen h-0 w-full flex flex-col md:flex-row justify-center items-center max-w-[1400px] mx-auto gap-10 p-4'>
				<div className=' w-full md:w-1/2 flex flex-col gap-4 lg:gap-10 '>
					...
					<p className=' lg:text-2xl'>
						Join thousands of gamers from around the world and unleash your gaming prowess. Share
						your thoughts on your favorite games, discover hidden gems, and engage in lively
						discussions with fellow gamers who share your passion.
					</p>
			...
			<Counter />
			<main className='min-h-screen h-0 w-full flex flex-col md:flex-row justify-center items-center max-w-[1400px] mx-auto gap-10 p-4'></main>
		</>
	);
}
